...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO meosOnlinePunch SET cid=?, code=?, cardno=?, time=?";
...
<tr>
<td>Card number:</td><td><input type="text" name="user" size="6" required></td><td>You may provide several space separated card numbers.</td>
</tr>
<tr>
